...
<item:projecte:dm_pedestal>.addTooltip("Only mineable with ProjectE tools.");
<item:trials:ominous_bottle>.addTooltip("Possible reward of a Trial Vault in a Trial Chamber.");
<item:draconicevolution:creative_capacitor>.addTooltip('Press the "L" key to open item settings.');
<item:draconicevolution:chaotic_capacitor>.addTooltip('Press the "L" key to open item settings.');
<item:draconicevolution:draconic_capacitor>.addTooltip('Press the "L" key to open item settings.');
<item:draconicevolution:wyvern_capacitor>.addTooltip('Press the "L" key to open item settings.');
